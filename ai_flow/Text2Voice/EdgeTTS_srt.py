...
async def process_subtitles(subtitles):
    ...
    for subtitle in subtitles:
        try:
            ...
            seconds = subtitle.start.hours * 3600 + subtitle.start.minutes * 60 + subtitle.start.seconds
            ...
            # 保存音频片段和其开始时间
            audio_segments.append((seconds * 1000 + subtitle.start.milliseconds, audio))  # 转换为毫秒
